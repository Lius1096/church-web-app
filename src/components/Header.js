...
function Header() {
  return (
    ...
    <nav className="flex items-center justify-between py-4 px-8 bg-gray-800">
      <div>
        {/* Déplacez le logo ici */}
        <div className="flex items-center">
          <img src={Essaie1} alt="Logo" className="h-48 w-auto mr-2" /> {/* Ajoutez des classes pour définir la taille du logo */}
          <Link to="/" className="text-white font-semibold text-xl"></Link>
        </div>
      </div>
